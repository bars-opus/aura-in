  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-4">
      ...
      <textarea
        ...
        rows={3}
        maxLength={1000}
        className="mt-3 w-full bg-white text-slate-900 placeholder:text-slate-400 border border-slate-200 rounded-lg px-3 py-2.5 text-sm resize-y"
      />
      ...
      <button
        ...
        onClick={onSubmit}
        className="mt-3 w-full bg-brand-500 text-white text-sm font-medium rounded-lg py-2.5 disabled:bg-slate-300 disabled:cursor-not-allowed"
      >
