...
> **If an incident occurs and no checklist item would have caught it, a new item must be proposed within 5 business days.** > **Last updated**: 2026-05-21
...
_Complete during algorithm design, before writing code._
...
_Complete during code review, before merging PR._
...
_Apply to any algorithm that records, moves, computes, or audits monetary value._
...
_Complete before performance testing._
...
_Complete before deployment to production._
...
_Complete for user-facing algorithms; skip `[UI]` checks for backend-only._
...
_Complete before merge; attach evidence to PR._
...
_Complete before production deployment._
...
_Complete within 24 hours of production deployment._
...
> **Context**: [ ] Service/API [ ] Batch job [ ] One-off script [ ] UI-facing [ ] Other: \_\_\_\_
